...
# Supported Games
Currently Gomoku and Chinese Chess 
...
./mcts_test ./weights/423.onnx 1   (now saved in "model" dir)
...
本项目支持windows和linux平台。由于我主要在linux上训练，windows相应的代码不会及时更新，需要自行修改一下才能用。
